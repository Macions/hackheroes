        ...
        <nav>
            <div class="nav-container">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="o-projekcie.html" class="active">O projekcie</a></li>
    ...
    <main id="main-content">
        ...
        <section class="hero-section">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Poznaj misję, historię i wartości, które przyświecają naszej społeczności młodych twórców</p>
                <div class="hero-stats">
                    <div class="stat">
                        <span class="stat-number">2+</span>
                        <span class="stat-label">Lata działalności</span>
                    </div>
                    <div class="stat">
                    ...
                    <div class="stat">
                        ...
                        <span class="stat-label">Zaangażowanych młodych</span>
                    </div>
                </div>
            </div>
                ...
                <div class="mission-content">
                    <div class="mission-text">
                        ...
                        <p class="mission-statement">
                            TeenCollab to platforma, która łączy młodych ludzi z całej Polski, umożliwiając im rozwój umiejętności technicznych, 
                            tworzenie realnych projektów społecznych i budowanie wartościowej społeczności. Wierzymy, że każdy młody człowiek 
            ...
            <div class="container">
                ...
                <div class="goals-grid">
                    <div class="goal-card">
                        ...
                        <p>Praktyczna nauka technologii przyszłości poprzez realne projekty i mentoring doświadczonych developerów</p>
                    ...
                    <div class="goal-card">
                        ...
                        <p>Od pomysłu do implementacji - młodzi tworzą rozwiązania dla realnych problemów społecznych</p>
                        <ul class="goal-features">
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Grupa zapalonych uczniów stworzyła pierwszy prototyp platformy do współpracy nad projektami szkolnymi</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Ukończono 15 pierwszych projektów, społeczność rozrosła się do 100 aktywnych członków z 5 miast</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Platforma zdobyła grant rozwojowy, nawiązano partnerstwa z 10 szkołami, uruchomiono program mentoringowy</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <h3>Obecnie</h3>
                            <p>500+ aktywnych członków, 100+ zrealizowanych projektów, społeczność obecna w 20+ miastach w Polsce</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="process-steps">
                    <div class="process-step">
                        ...
                        <div class="step-content">
                            ...
                            <p>Młodzi wybierają interesujące ich inicjatywy lub proponują własne pomysły poprzez naszą platformę</p>
                        </div>
                    </div>
                    ...
                    <div class="process-step">
                        ...
                        <div class="step-content">
                            ...
                            <p>Uczestnicy pracują w międzyszkolnych grupach, korzystając z narzędzi collaboration i wsparcia mentorów</p>
                        </div>
                    </div>
                    ...
                    <div class="process-step">
                        ...
                        <div class="step-content">
                            ...
                            <p>Gotowe projekty są prezentowane społeczności, otrzymują feedback i są wdrażane w życie</p>
                        </div>
                    </div>
                    ...
                    <div class="process-step">
                        ...
                        <div class="step-content">
                            ...
                            <p>Najlepsze projekty otrzymują wsparcie w dalszym rozwoju, a uczestnicy - certyfikaty i rekomendacje</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="achievements-grid">
                    ...
                    <div class="achievement-card">
                        ...
                        <div class="achievement-label">Miast w Polsce</div>
                    </div>
                </div>
                ...
                <div class="success-stories">
                    ...
                    <div class="stories-grid">
                        ...
                        <div class="story-card">
                            ...
                            <p>Nawiazaliśmy współpracę z wiodącą firmą technologiczną, która wspiera nasze inicjatywy</p>
                        </div>
        ...
        <section class="cta-section">
            <div class="container">
                <div class="cta-content">
                    ...
                    <p>Dołącz do społeczności młodych ludzi, którzy razem tworzą, uczą się i zmieniają świat na lepsze. Nie czekaj - Twój projekt może być następny!</p>
